...
<!-- BEGIN LOGIN FORM -->
  {!! Form::open(['url' => '/login', 'class' => 'login-form', 'role' => 'form', 'method' => 'post']) !!}
      ...
      <div class="form-group">
          ...
          <input class="form-control form-control-solid placeholder-no-fix" type="text" placeholder="E-Posta" name="email" /> </div>
      <div class="form-group">
          <label class="control-label visible-ie8 visible-ie9">Şifre</label>
          <input class="form-control form-control-solid placeholder-no-fix" type="password" placeholder="Şifre" name="password" /> </div>
